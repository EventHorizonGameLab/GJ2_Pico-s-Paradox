...
public class PlayerAnimation : MonoBehaviour
{
    ...
    {
        if(actualHoldPoint.localPosition.x > 0) { idleOrientation = Vector3.right; }
        else if(actualHoldPoint.localPosition.x < 0) { idleOrientation = Vector3.left; }
        if(actualHoldPoint.localPosition.z > 0) { idleOrientation = Vector3.forward; }
        else if (actualHoldPoint.localPosition.z < 0) { idleOrientation = Vector3.back;}
